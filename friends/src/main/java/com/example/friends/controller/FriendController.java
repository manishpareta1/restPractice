...
import com.example.friends.error.ErrorMessage;
...
public class FriendController {
    ...
    Friend create(@RequestBody Friend friend) throws ValidationException{
        ...
        if(friend.getId() == 0 && friend.getFirstName()  != null && friend.getLastName() != null){
            ...
            throw new ValidationException("Friend cannot be create, Please validate the data");
        }
    }
    ...
    ResponseEntity<Optional<Friend>> getFriendById(@PathVariable Integer id){
        ...
        if(optionalFriend.isPresent())
            ...
            return new ResponseEntity(optionalFriend, HttpStatus.BAD_REQUEST);
        }
    }
